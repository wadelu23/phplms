...
$tot=0;
$res=mysqli_query($link,"SELECT * FROM messages WHERE susername='$_SESSION[username]'&& sread='n'");
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="message_from_librarian.php"><i class="fa fa-desktop"></i> MSG <span
