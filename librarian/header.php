                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="books_details_with_student.php"><i class="fa fa-table"></i> Books All Info <span class="fa fa-chevron-down"></span></a>
                            </li>

                            <li><a href="send_notification_student.php"><i class="fa fa-mail-forward"></i> Send MSG to student <span class="fa fa-chevron-down"></span></a>
                            </li>
